function [links, k_lim, k_unsafe_A, k_unsafe_b] = compute_unsafe_parameters_3link2d(varargin)
...
links = stack_FRS_3link2d(theta_0, theta_dot_0); % this also slices at the correct initial velocity
nLinks = length(links);
