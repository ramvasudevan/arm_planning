function [Q] = get_fetch_q_from_traj(X)
...
tic
qj1 = fsolve(@(q) joint1_IK(X0(1:3, 1), q), [0;0], options);
qj2 = fsolve(@(q) joint2_IK(X0(4:6, 1), qj1, q), [0;0], options);
qj3 = fsolve(@(q) joint3_IK(X0(7:9, 1), [qj1;qj2], q), [0;0], options);
