...
plot_HLP_flag = false ; % for planner
...
file_location = 'arm_planning/simulator_files/testing/trial_data/20200130_RRTstar' ;
...
% % HACK 20200128
% % DO IT AGAIN! but for a different planner:
% %% description
% % This script iterates through a list of presaved random worlds and runs
% % the aRmTD planner on them. It then saves information on how well each the
% % planner performed in each trial.
...
% % file handling
% save_file_header = 'trial_' ;
% file_location = 'arm_planning/simulator_files/testing/trial_data/20200128_RRT' ;
% if ~exist(file_location, 'dir')
%     mkdir(file_location);
% end
% 
