classdef robot_arm_3D_1link_2DOF_thin < robot_arm_agent
    methods
        function A = robot_arm_3D_1link_2DOF_thin(varargin)
            dimension = 3 ;
...
%                           0.05, 0.025, 0.05, 0.025] ; % size in z
            ...
            joint_axes = [0 0 ;
                          0 1 ;
                          1 0 ] ; % axes are in preceding link's frame
                      
            joint_locations = [+0.001, +0.00 ; % predecessor x
                               +0.00, +0.00 ; % predecessor y
                               +0.00, +0.00 ; % predecessor z
                               +0.00, -0.33/2 ; % successor x
                               +0.00, +0.00 ; % successor y
                               +0.00, +0.00 ];% successor z
