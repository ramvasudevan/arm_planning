classdef robot_arm_3D_fetch_thin < robot_arm_agent
    methods
        function A = robot_arm_3D_fetch_thin(varargin)
            dimension = 3 ;
...
%                           0.05, 0.025, 0.05, 0.025] ; % size in z
            ...
            link_sizes = [0.001, 0.330, 0.001, 0.330, 0.001, 0.330 ;  % size in x
                          0.001, 0.001, 0.001, 0.001, 0.001, 0.001 ;  % size in y
                          0.001, 0.001, 0.001, 0.001, 0.001, 0.001] ; % size in z
