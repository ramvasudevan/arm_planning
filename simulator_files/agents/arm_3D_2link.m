classdef arm_3D_2link < robot_arm_agent
    methods
        function A = arm_3D_2link(varargin)
            dimension = 3 ;
            
            link_shapes = {'cuboid', 'cylinder','cuboid','cylinder'} ;
            
            link_sizes = [0.01, 0.50, 0.01, 0.50;
                0.01, 0.10, 0.01, 0.10 ;
                0.01, 0.10, 0.01, 0.10] ;
            ...
            joint_state_limits = [-inf -pi/2 -inf -pi/2;
                inf pi/2 inf pi/2];
            
            joint_speed_limits = 2*pi.*[-1 -1 -1 -1 ; 1 1 1 1] ;
