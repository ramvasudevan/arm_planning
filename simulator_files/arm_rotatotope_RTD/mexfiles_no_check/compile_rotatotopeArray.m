...
% interface sources
files = [ 'rotatotope_mex_no_check.cu ', ...
          'rotatotope_NLP.cu ', ... 
          'rotatotopeArray.cu'] ;
...
LIBS2 = '-Wl,-Bstatic -L/opt/local2/lib -lipopt -L/opt/local2/lib -lcoinlapack -L/opt/local2/lib -lcoinmumps -L/opt/local2/lib -lcoinblas -Wl,-Bdynamic ';
...
cmd = sprintf('mexcuda %s %s %s %s',INCL,files,MEXFLAGS,LIBS) ;
eval(cmd);
